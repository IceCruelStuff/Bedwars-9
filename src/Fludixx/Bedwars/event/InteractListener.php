...
class InteractListener implements Listener
{
    ...
    public function onInteract(PlayerInteractEvent $event)
    {
        ...
        if ($mplayer->getPos() === 0 && $tile instanceof Sign && $tile->getLine(0) === Bedwars::NAME) {
            ...
            } else if($tile->getLine(3) === Bedwars::RUNNING || $tile->getLine(3) === Bedwars::FULL) {
                $arena = Bedwars::$arenas[$tile->getLine(1)];
    ...
    {
        $p = $event->getPacket();
        if ($p instanceof ModalFormResponsePacket && $p->formId === 156) {
